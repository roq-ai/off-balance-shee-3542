...
export const HelpBox: React.FC = () => {
  ...
  const tenantRoles: string[] = ['Inventory Manager', 'Finance Officer', 'Business Owner', 'ERP Administrator'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Off-balance sheet financing for inventory purchases. `;

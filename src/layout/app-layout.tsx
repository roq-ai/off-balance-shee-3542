...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'inventory-manager', 'finance-officer', 'erp-administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Erp', path: '/erps', entity: 'erp', service: AccessServiceEnum.PROJECT, icon: FiSettings },
    { name: 'Finance', path: '/finances', entity: 'finance', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },

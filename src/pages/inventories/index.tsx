...
function InventoryListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<InventoryInterface[]>(
    ...
    () =>
      getInventories({
        relations: ['organization', 'finance.count', 'order.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('finance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>finance</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('finance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.finance}</Td>
                    )}
